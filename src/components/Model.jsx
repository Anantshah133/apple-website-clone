...
const Model = () => {
    ...
    // Camera Control for the small model
                    ...
                    <div className='w-full mx-auto'>
                        ...
                        <div className='flex-center'>
                            <ul className='color-container'>
                                {/* {} Dynamic Block */}
                                {models.map((item, idx)=>(
                                    <li key={idx} className='w-6 h-6 rounded-full mx-2 cursor-pointer' style={{backgroundColor: item.color[0]}} onClick={()=>setModel(item)}></li>
                                ))}
                            </ul>
